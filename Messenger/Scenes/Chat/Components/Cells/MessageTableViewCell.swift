...
extension MessageTableViewCell {
	...
	override func setSubviewsConstraints() {
		NSLayoutConstraint.activate([
			...
			userView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 8.0),
			...
			messageView.leadingAnchor.constraint(equalTo: userView.trailingAnchor, constant: 8.0),
